...
lyr_WorldStreets_0.setVisible(true);lyr_WorldImagery_1.setVisible(true);lyr_EnforcementTowns_2.setVisible(true);lyr_UnregisteredwithPRA_3.setVisible(true);
var layersList = [lyr_WorldStreets_0,lyr_WorldImagery_1,lyr_EnforcementTowns_2,lyr_UnregisteredwithPRA_3];
...
lyr_UnregisteredwithPRA_3.on('precompose', function(evt) {
